...
// lucide-react dropped trademarked brand icons (Instagram/Facebook/LinkedIn/
// Twitter/YouTube) from its export list — these are small inline SVGs filling
// that gap, matching the approach already used for WhatsApp.
...
export function TwitterIcon({ className }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className ?? "w-4 h-4"} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M17.53 3H21l-7.19 8.21L22 21h-6.56l-5.14-6.06L4.6 21H1l7.68-8.78L2 3h6.72l4.66 5.53L17.53 3zM16.3 19.1h1.82L7.86 4.8H5.9l10.4 14.3z" />
    </svg>
  );
}
...
export function GoogleIcon({ className }: BrandIconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className ?? "w-4 h-4"} xmlns="http://www.w3.org/2000/svg">
