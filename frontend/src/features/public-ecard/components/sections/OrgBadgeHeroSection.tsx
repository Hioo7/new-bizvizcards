...
interface OrgBadgeHeroSectionProps {
  hero: EcardHero;
  endpoint: string;
...
// showing the linked organisation's logo.
export function OrgBadgeHeroSection({
  hero,
  endpoint,
  canExchangeContact,
  onExchangeContact,
      ...
      <div className="relative">
        ...
        <div className="h-full w-full rounded-2xl border border-base-300 bg-base-100 p-8 text-center md:flex md:items-center md:text-left">
          <div className="relative mx-auto h-32 w-32 shrink-0 md:mx-0">
            <div className="h-32 w-32 overflow-hidden rounded-full bg-base-200">
            ...
            <div
              className="absolute bottom-0 right-0 flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border-2 border-base-100"
              style={{ backgroundColor: hero.badgeFallbackColor ?? undefined }}
            >
              {hero.organisationLogoUrl && (
                <img
                  src={hero.organisationLogoUrl}
                  alt=""
                  className="h-full w-full object-cover"
                />
              )}
