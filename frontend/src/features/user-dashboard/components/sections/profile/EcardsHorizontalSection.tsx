        ...
        >
          {ecards.map((ecard) => (
            ...
            >
              ...
              >
                {/* Top row: chip logo + profile photo */}
                <div className="flex items-start justify-between pr-14">
                  ...
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-base-200 ring-2 ring-white/80 shadow-sm">
                    {ecard.hero.profilePhotoUrl ? (
                      ...
                      <UserRound className="h-4.5 w-4.5 text-base-content/30" aria-hidden="true" />
                    )}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <p className="text-xs text-base-content/40 truncate tracking-wide">
                      /{ecard.endpoint}
                    </p>
                    <span className="shrink-0 text-[10px] tracking-widest font-medium text-base-content/25 uppercase select-none">
                      BizViz
                    </span>
                  </div>
                </div>
              ...
              <button
                ...
                className="absolute top-3 right-3 z-20 flex h-11 w-11 items-center justify-center rounded-full bg-base-100/90 text-base-content/60 shadow-md backdrop-blur-sm transition-all hover:bg-base-100 hover:text-primary active:scale-95"
              >
                <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5" aria-hidden="true">
              ...
              >
                <button
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-full text-primary hover:bg-primary/10 active:scale-95 transition-all"
                >
                  <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5" aria-hidden="true">
                ...
                <button
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-full text-base-content/25 opacity-50 cursor-not-allowed"
                >
                ...
                <button
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-full text-base-content/40 hover:text-primary hover:bg-primary/10 active:scale-95 transition-all"
                >
                  <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5" aria-hidden="true">
                ...
                <button
                  type="button"
                  onClick={() => setDeletingEcard(ecard)}
                  aria-label="Delete e-card"
                  className="flex h-11 w-11 items-center justify-center rounded-full text-base-content/25 hover:text-error hover:bg-error/10 active:scale-95 transition-all"
                >
                  <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5" aria-hidden="true">
