...
export default function SmartCardListItem({
  ...
  return (
    <div className="flex items-center gap-3 border-b border-base-300 px-4 py-3.5 last:border-b-0 hover:bg-base-200/50">
      <span className="relative flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full bg-accent/10 text-accent">
        ...
        {card.customerId && (
          <span
            ...
            className="absolute -bottom-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-accent text-accent-content ring-2 ring-base-100"
          >
