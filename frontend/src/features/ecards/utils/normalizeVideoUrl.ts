// Mirrors the backend's normalize-video-url.util.ts exactly — kept in sync
// so the client-side check accepts precisely what the server will accept.
...
// recognizable YouTube/Vimeo video link.
