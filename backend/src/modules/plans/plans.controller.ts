...
import { bulkAssignPlanCustomersSchema } from './dto/bulk-assign-plan-customers.dto';
import type { BulkAssignPlanCustomersDto } from './dto/bulk-assign-plan-customers.dto';
...
export class PlansController {
  ...
  bulkAssign(
    @Param('id') id: string,
    @Body(new ZodValidationPipe(bulkAssignPlanCustomersSchema))
    dto: BulkAssignPlanCustomersDto,
    @Req() request: EmployeeAuthenticatedRequest,
  ) {
    return this.planAssignmentsService.bulkAssign(
      id,
      dto.customerIds,
