/*
  ...
  - You are about to drop the column `whatsapp` on the `ECardSocialLinksComponent` table. All the data in the column will be lost.

*/
-- AlterEnum
ALTER TYPE "ECardComponentType" ADD VALUE 'WHATSAPP';
...
-- AlterTable
ALTER TABLE "ECardSocialLinksComponent" DROP COLUMN "whatsapp";
...
-- CreateTable
CREATE TABLE "ECardWhatsAppComponent" (
    "ecardComponentId" UUID NOT NULL,
    "phoneCountryDialCode" TEXT NOT NULL,
    "phoneNumber" TEXT NOT NULL,

    CONSTRAINT "ECardWhatsAppComponent_pkey" PRIMARY KEY ("ecardComponentId")
);

-- AddForeignKey
ALTER TABLE "ECardWhatsAppComponent" ADD CONSTRAINT "ECardWhatsAppComponent_ecardComponentId_fkey" FOREIGN KEY ("ecardComponentId") REFERENCES "ECardComponent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
