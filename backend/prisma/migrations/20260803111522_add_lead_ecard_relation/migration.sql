...
-- AlterTable
ALTER TABLE "Lead" ADD COLUMN     "ecardId" UUID,
...
-- CreateIndex
CREATE INDEX "Lead_ecardId_idx" ON "Lead"("ecardId");

-- AddForeignKey
ALTER TABLE "Lead" ADD CONSTRAINT "Lead_ecardId_fkey" FOREIGN KEY ("ecardId") REFERENCES "ECard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
