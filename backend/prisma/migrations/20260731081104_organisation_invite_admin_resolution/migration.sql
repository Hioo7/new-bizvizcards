-- AlterEnum
ALTER TYPE "OrganisationInviteStatus" ADD VALUE 'RESOLVED';
...
-- AlterTable
ALTER TABLE "OrganisationInvite" ADD COLUMN     "resolvedByEmployeeId" UUID,
...
-- AddForeignKey
ALTER TABLE "OrganisationInvite" ADD CONSTRAINT "OrganisationInvite_resolvedByEmployeeId_fkey" FOREIGN KEY ("resolvedByEmployeeId") REFERENCES "Employee"("id") ON DELETE SET NULL ON UPDATE CASCADE;
