-- CreateEnum
CREATE TYPE "ECardTrafficSource" AS ENUM ('DIRECT', 'VIRTUAL_BACKGROUND');
...
-- AlterTable
ALTER TABLE "ECardEvent" ADD COLUMN     "source" "ECardTrafficSource" NOT NULL DEFAULT 'DIRECT',
ADD COLUMN     "sourceRefId" UUID,
...
-- CreateIndex
CREATE INDEX "ECardEvent_sourceRefId_type_createdAt_idx" ON "ECardEvent"("sourceRefId", "type", "createdAt");
