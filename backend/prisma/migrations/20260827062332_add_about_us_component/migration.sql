-- AlterEnum
ALTER TYPE "ECardComponentType" ADD VALUE 'ABOUT_US';
...
-- CreateTable
CREATE TABLE "ECardAboutUsComponent" (
    "ecardComponentId" UUID NOT NULL,
    "tagline" TEXT,
    "content" TEXT,

    CONSTRAINT "ECardAboutUsComponent_pkey" PRIMARY KEY ("ecardComponentId")
);

-- AddForeignKey
ALTER TABLE "ECardAboutUsComponent" ADD CONSTRAINT "ECardAboutUsComponent_ecardComponentId_fkey" FOREIGN KEY ("ecardComponentId") REFERENCES "ECardComponent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
