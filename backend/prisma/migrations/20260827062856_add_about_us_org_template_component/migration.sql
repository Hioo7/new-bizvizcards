...
-- CreateTable
CREATE TABLE "OrganisationEcardTemplateAboutUsComponent" (
    "templateComponentId" UUID NOT NULL,
    "tagline" TEXT,
    "content" TEXT,

    CONSTRAINT "OrganisationEcardTemplateAboutUsComponent_pkey" PRIMARY KEY ("templateComponentId")
);

-- AddForeignKey
ALTER TABLE "OrganisationEcardTemplateAboutUsComponent" ADD CONSTRAINT "OrganisationEcardTemplateAboutUsComponent_templateComponen_fkey" FOREIGN KEY ("templateComponentId") REFERENCES "OrganisationEcardTemplateComponent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
