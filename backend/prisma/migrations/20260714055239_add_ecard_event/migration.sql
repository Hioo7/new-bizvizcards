-- CreateEnum
CREATE TYPE "ECardEventType" AS ENUM ('VIEW', 'WALLET_SAVE');
...
-- CreateTable
CREATE TABLE "ECardEvent" (
    "id" UUID NOT NULL DEFAULT pg_catalog.gen_random_uuid(),
    "ecardId" UUID NOT NULL,
    "type" "ECardEventType" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ECardEvent_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "ECardEvent_ecardId_type_createdAt_idx" ON "ECardEvent"("ecardId", "type", "createdAt");

-- AddForeignKey
ALTER TABLE "ECardEvent" ADD CONSTRAINT "ECardEvent_ecardId_fkey" FOREIGN KEY ("ecardId") REFERENCES "ECard"("id") ON DELETE CASCADE ON UPDATE CASCADE;
