-- CreateEnum
CREATE TYPE "SmartCardLogoShape" AS ENUM ('CIRCLE', 'RECTANGLE', 'FREEFORM');
...
-- AlterTable
ALTER TABLE "SmartCardProfile" ADD COLUMN     "logoShape" "SmartCardLogoShape" NOT NULL DEFAULT 'CIRCLE';
